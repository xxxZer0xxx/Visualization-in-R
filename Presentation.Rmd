...
vielleicht eher als screenshot
...
## Create your first code chunks

`I will show you how to use the following commands on the count variabel in the bike rental dataset`  
`summary()`  
`mean()`  
`sd()`  
