...
* \textcolor{green-code}{toc}: yes  
* \textcolor{green-code}{bibliography}: biblioraphy.bib  
* \textcolor{green-code}{csl}: csl_style.csl  
* \textcolor{green-code}{abstract}: Space to write an abstract  
* \textcolor{green-code}{css}: use custom css
