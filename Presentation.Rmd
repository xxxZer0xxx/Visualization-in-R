...
* Consolidate your analysis and document into a single file
* Easy for version Control (e.g. Git/GitHub)
* Your output file will look great with hardly any effort on your part
...
and reproduce something like the following: 
\begin{center}
\includegraphics[scale=0.35]{IMG/ExerciseExample}
\end{center}
...
4. Use the command `plot()` to generate a scatterplot. Do not print the code!
5. Add some plain text, divided into two lines:
    + "Figure I:
    + Correlation of count and temperature"
